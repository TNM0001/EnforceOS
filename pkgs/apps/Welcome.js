export default {
  ...
  strings: {
    en_US: {
      ...
      welcome_page1_header: "Welcome to EnforceOS",
      welcome_page1_body:
        "Hey there! Welcome to EnforceOS, a new 'desktop environment' for the web.\n\nPress Next to enter setup.",
    ...
    en_GB: {
      ...
      welcome_page1_header: "Welcome to EnforceOS",
      welcome_page1_body:
        "Hello! Welcome to EnforceOS, a new 'desktop environment' for the web.\n\nPress the Next button to enter the setup process.",
      welcome_page2_header: "Set your language",
    ...
    de_DE: {
      ...
      welcome_page1_header: "Willkommen bei EnforceOS",
      welcome_page1_body:
        'Hallo! Wilkommen bei EnforceOS, einem neuem Desktop-environment für das Web.\n\nDrücken Sie "Nächste Seite" um die Einstellungen zu öffnen',
    ...
    es_ES: {
      ...
      welcome_page1_header: "Bienvenido a EnforceOS",
      welcome_page1_body:
        "¡Hola! Bienvenido a EnforceOS, un nuevo 'entorno de escritorio' para la web.\n\nPresione Siguiente para ingresar la configuración.",
    ...
    pt_BR: {
      ...
      welcome_page1_header: "Bem-vindo a EnforceOS",
      welcome_page1_body:
        "Ola! Bem-vindo a EnforceOS, um novo 'ambiente de desktop' para a web.\n\nPressione o próximo para entrar na instalação.",
  ...
  exec: async function (Root) {
    ...
    let pages = {
      ...
      async p3() {
        ...
        const themes = await vfs.list("Root/Enforce/config/themes");
          ...
          await Promise.all(
            themes.map(async (t) => {
              ...
              const result = await ThemeLib.validateTheme(
                await vfs.readFile("Root/Enforce/config/themes/" + t.item)
              );
