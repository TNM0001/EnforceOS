let templateFsLayout = {
  Root: {
    Enforce: {
      panics: {
        "README.MD":
          "This folder is designed to help store logs when EnforceOS crashes. If you have any worries about the logs please contact us with them.",
      },
      config: {
        ...
        themes: {
          ...
          "grey.theme":
            '{"version":1,"name":"Grey","description":"A built-in theme.","values":null,"cssThemeDataset":"grey","wallpaper":"./assets/wallpapers/grey.png"}',
          "red.theme":
