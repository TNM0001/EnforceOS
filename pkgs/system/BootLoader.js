...
export default {
  ...
  exec: async function (Root) {
    ...
    try {
      ...
      if (await vfs.exists("Root/Enforce/config/fsVersionUpdate.txt")) {
        let version = await vfs.readFile("Root/Enforce/config/fsVersionUpdate.txt");
      ...
      await vfs.writeFile(
        "Root/Enforce/config/fsVersionUpdate.txt",
      ...
      if (appearanceConfig.theme && appearanceConfig.theme.endsWith(".theme")) {
        const x = themeLib.validateTheme(
          await vfs.readFile(
            "Root/Enforce/config/themes/" + appearanceConfig.theme
          )
        );
