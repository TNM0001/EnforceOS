export default {
  ...
  exec: async function (Root) {
    ...
    async function toggleMenu() {
      ...
      if (menuIsOpen === true) {
        ...
        if (!menuElm) {
          ...
          const installedApps = (await vfs.list("Root/Enforce/apps"))
    ...
    if (await vfs.exists("Root/Enforce/startup")) {
      let startupApps = await vfs.readFile("Root/Enforce/startup").then((e) => {
        return e.split("\n").filter((e) => e !== "");
      });
